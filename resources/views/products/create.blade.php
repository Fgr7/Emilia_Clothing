...
<form action="{{ route('products.store') }}" method="POST" class="bg-white w-1/3 p-4 border-gray-100 shadow-xl rounded-lg ml-96 mt-6">
    ...
    <button type="submit" class="my-3 w-full  bg-pink-500 p-2 font-semibold rounded text-white hover:bg-pink-600 ">Send</button>
        <br>
        <br>
   <a href="{{ route('products.index') }}"  class="my-3 w-full  bg-pink-500 p-2 font-semibold rounded text-white hover:bg-pink-600 "><< Back</a>
